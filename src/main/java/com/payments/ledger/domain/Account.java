...
/**
 * In-memory account record (standard double-entry semantics) with these
 * deliberate simplifications:
 * <ul>
 *   <li>{@code id} is u128 ({@link UInt128}); amounts are u64 (long) — signed in
 *       Java but always treated as unsigned, max 9.2e18 (ample for any currency in minor units).</li>
